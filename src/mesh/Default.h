...
#define min_default_telemetry_interval_secs 60
#define default_gps_update_interval IF_ROUTER(ONE_DAY, 60)
...
#define min_default_broadcast_interval_secs 60 
...
#define min_node_info_broadcast_secs 60 // No regular broadcasts of more than once an hour
